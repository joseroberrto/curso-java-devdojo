...
public class ReentrantReadWriteLockTest01 {
    public static void main(String[] args) {
        ...
        Runnable reader = ()->{
            ...
            rwl.readLock().lock();
            System.out.println(Thread.currentThread().getName()+" FINALLY I GOT THE  DAMN LOCK");
            try {

                System.out.println(Thread.currentThread().getName()+ mapReadWrite.allKey());
            }finally {
                rwl.readLock().unlock();
            }
        };
        ...
        new Thread(writer,"Escritor").start();
        new Thread(reader,"Leito 1").start();
        new Thread(reader,"Leitor 2").start();
    }
}
